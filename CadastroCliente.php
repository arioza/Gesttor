...
<div class="container">
    <h2 style="text-align: center; margin-top: 20px">Novo Cliente</h2>

    <form action="_cadastraCliente.php" method="POST">
        <div class="row">
            <div class="col-md-6">
                <label>Nome</label>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <label>CPF</label>
                        <input name="cpf" type="id" class="form-control" >
                    </div>
                    <div class="col-md-6">
                        <label>Telefone</label>
                        <input name="telefone" type="phone" class="form-control">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <label>Celular</label>
                        <input name="celular" type="phone" class="form-control" required>
                    </div>
                    <div class="col-md-6">
                        <label>E-mail</label>
