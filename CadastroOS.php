...
<div class="container">
    <h2 style="text-align: center; margin-top: 20px">Nova Ordem de Serviço</h2>
    ...
    <form action="_cadastraUsuario.php" method="POST">
        ...
        <div class="row">
            <div class="col-md-2 offset-md-5">
                <button type="submit" class="btn btn-success    " style="width: 155px; margin-top: 20px">Cadastrar</button>
            </div>
        </div>
    </form>
</div>
